# Source Code Export
Below is the combined source code of the main application files.
...
```json
{
  ...
  "type": "module",
  "scripts": {
    "dev": "concurrently \"vite\" \"tsx api/index.ts\"",
    "build": "vite build",
...
<html lang="en">
  <head>
    ...
    <title>Rus-Exchange — Обмен валют</title>
  </head>
  <body>
    <div id="root"></div>
